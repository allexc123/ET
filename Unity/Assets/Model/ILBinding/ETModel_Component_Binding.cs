...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Component_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("get_IsDisposed", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsDisposed_0);
            args = new Type[]{};
        ...
        static StackObject* get_IsDisposed_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.IsDisposed;
